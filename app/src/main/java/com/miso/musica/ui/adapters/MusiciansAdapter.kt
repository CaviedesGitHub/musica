...
import com.miso.musica.databinding.MusicianItemBinding
import com.miso.musica.models.Musician
import com.miso.musica.ui.MusicianFragmentDirections
...
class MusiciansAdapter : RecyclerView.Adapter<MusiciansAdapter.MusicianViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MusicianViewHolder {
        val withDataBinding: MusicianItemBinding = DataBindingUtil.inflate(
            ...
            parent,
            false)
        return MusiciansAdapter.MusicianViewHolder(withDataBinding)
    }
